...
{
    public static IServiceBusLogContext<TServiceBusMessage> GetLogContext<TServiceBusMessage>
        (this TServiceBusMessage message,
        IConfiguration configuration, LogLevel severity) where TServiceBusMessage : IServiceBusMessage, new()
    {
