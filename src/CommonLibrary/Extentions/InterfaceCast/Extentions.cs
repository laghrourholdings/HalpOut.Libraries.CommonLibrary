namespace CommonLibrary.Extentions.InterfaceCast;
using System;
...
/// <summary>
/// Extension method that provides interface typing for extended types.
/// 
...
/// </summary>
public static class InterfaceCastExtention
{
    /// <summary>
    /// Returns a proxy object of type T who's implementation is provided by the subject of the interface type cast
    /// </summary>
    ...
    public static T InterfaceCast<T>(this object subject) where T : class
    {
